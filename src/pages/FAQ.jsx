              ...
              <AnswerWrap pb={4}>
                ...
                <div style={{display:"flex"}}>
                    ...
                    <a href="https://twitter.com/PPPandasNFT">
                      <img src={Twitter} alt="Bamboo" style={{ width: "40px",paddingRight:"10px" }} />
                    </a>
                    <a href="https://discord.gg/pppandas">
                      <img src={Discord} alt="Bamboo" style={{ width: "40px",paddingRight:"10px" }} />
                    </a>
                    <a href="https://www.instagram.com/ppp.nft/">
                      <img src={Instagram} alt="Bamboo" style={{ width: "40px",paddingRight:"10px" }} />
                    </a>
                </div>  
              </AnswerWrap>
            </AccordionItemWrap>
